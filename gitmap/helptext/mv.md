...
**Output:**
    ...
    [mv] resolving LEFT : ./gitmap-v10 (folder)
    [mv] resolving RIGHT : ./gitmap-v10 (folder)
...
**Output:**
    ...
    [mv] resolving RIGHT : https://github.com/owner/gitmap-v10
    [mv]   -> mapped to working folder: /work/gitmap-v10
    [mv]   -> folder does not exist; cloning
    [mv]   -> clone OK
    [mv] copying files LEFT -> RIGHT (excluding .git/) ...
    [mv]   copied 142 files
    [mv] committing in https://github.com/owner/gitmap-v10 ...
    [mv]   commit a1b2c3d "gitmap mv from ./gitmap-v10"
    [mv] pushing https://github.com/owner/gitmap-v10 ...
    [mv]   push OK
    [mv] done
