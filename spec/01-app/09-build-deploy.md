...
```powershell
$ldflags = "-X 'github.com/alimtvnetwork/gitmap-v10/gitmap/constants.RepoPath=$absRepoRoot'"
...
```
  ...
  ──────────────────────────────────────────────────
  → Runner CWD: D:\wp-work\riseup-asia\gitmap-v10
  → Repo root: D:\wp-work\riseup-asia\gitmap-v10
...
| Repo root | Root of the gitmap-v10 project |
