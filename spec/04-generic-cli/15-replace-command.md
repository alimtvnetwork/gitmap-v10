...
**Example:** `git@github.com:alimtvnetwork/gitmap-v10.git`
→ `slug = "gitmap-v10"` → `base = "gitmap"`, `K = 7`.
...
replace: src/foo.go: 3 matches (gitmap-v4 → gitmap-v10)
replace: docs/setup.md: 1 match (gitmap-v10 → gitmap-v10)
...
